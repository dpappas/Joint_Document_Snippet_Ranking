...
for run in range(run_from, run_to):
    ...
    #############################################
    odir    = 'ablation_{}{}{}{}{}{}{}_{}_{}_bioasq_jpdrmm_2L_0p01_run_{}/'.format(
        int(use_sent_extra),
        int(use_doc_extra),
        int(use_OH_sim),
        int(use_W2V_sim),
    ...
    for epoch in range(max_epoch):
        ...
        if(best_dev_map is None or epoch_dev_map>=best_dev_map):
            ...
            waited_for += 1
        ##############################
        save_checkpoint(epoch, model, best_dev_map, optimizer, filename=os.path.join(odir, 'epoch_{}_checkpoint.pth.tar'.format(epoch)))
        ##############################
